...
Original file is located at
    https://colab.research.google.com/drive/1tLmkiYXqfLBnG2UvYUwrfsFnWJAYJgZJ
"""
...
# LogisticRegression algoritmasını uygulama
...
predicted_class = model.predict([example_input])[0]
...
# Logistic Regression "newton-cg" yöntemi için model oluşturma ve parametrelerini belirleme
model = LogisticRegression(penalty='l2', C=1.0, solver='newton-cg', max_iter=100)
...
# Logistic Regression "liblinear" yöntemi için model oluşturma ve parametrelerini belirleme
...
# Logistic Regression "sag" yöntemi için model oluşturma ve parametrelerini belirleme
model = LogisticRegression(penalty='l2', C=1.0, solver='sag', max_iter=100)
...
# Logistic Regression "saga" yöntemi için model oluşturma ve parametrelerini belirleme
model = LogisticRegression(penalty='l2', C=1.0, solver='saga', max_iter=100)
